...
AccelStepper motorA(1,MOTOR_A_STEP_PIN, MOTOR_A_DIR_PIN);     //GP első prm 1 volt
...
void configuration_motorSetup()
{
  ...
  motorA.setPinsInverted(false, false, false);   //f,f,t  ez volt eredetileg
  motorB.setEnablePin(MOTOR_B_ENABLE_PIN);
  motorB.setPinsInverted(false, false, false); // this one turns the opposite direction to A, hence inverted.    t,f,t volt eredetileg!
#endif
}
